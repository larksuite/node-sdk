...
export type InteractiveCardElement =
    ...
    | InteractiveCardNoteElement
    | InterfaceCardActionElement;
export interface InteractiveCardTitle
    extends Omit<InteractiveCardPlainTextItem, 'lines'> {
    i18n?: Record<string, string>;
}
export type InteractiveCardTextItem =
...
export type InteractiveCardActionItem =
    | InteractiveCardDatePickerActionItem
    | InteractiveCardButtonActionItem
    | InteractiveCardOverflowActionItem
    | InteractiveCardSelectMenuActionItem;
...
export interface InteractiveCardDatePickerActionItem
    extends InteractiveCardActionBaseItem {
...
export interface InteractiveCardButtonActionItem
    extends InteractiveCardActionBaseItem {
    tag: 'button';
    text?: InteractiveCardTextItem;
    url?: string;
...
export interface InteractiveCardOverflowActionItem
    extends InteractiveCardActionBaseItem {
    tag: 'overflow';
...
export interface InteractiveCardSelectMenuActionItem
    extends InteractiveCardActionBaseItem {
