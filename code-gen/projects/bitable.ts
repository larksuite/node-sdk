...
export default abstract class Client extends base {
    ...
    bitable = {
        ...
        appTable: {
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=bitable&resource=app.table&apiName=truncate&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=truncate&project=bitable&resource=app.table&version=v1 document }
             *
             * 整表清空
             *
             * 清空整张数据表的记录，支持按照视图筛选条件来清空视图内的记录
             */
            truncate: async (
                payload?: {
                ...
                return this.httpInstance
                    .request<any, { code?: number; msg?: string; data?: {} }>({
                        url: fillApiPath(
                            `${this.domain}/open-apis/bitable/v1/apps/:app_token/tables/:table_id/truncate`,
                            path
                        ),
                        method: "DELETE",
                        data,
        ...
        appConnector: {
            /**
             * {@link https://open.feishu.cn/api-explorer?project=bitable&resource=app.connector&apiName=create&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=create&project=bitable&resource=app.connector&version=v1 document }
             *
             * 创建连接器
             *
             * 创建连接器，该接口仅支持创建单个连接器。
            ...
            create: async (
                payload?: {
                    data: {
                        ...
                        copy_from_token?: string;
                        copy_from_table_id?: string;
                        source_type?: number;
                        sync_type?: number;
                        field_sync_type?: number;
                        sync_fields?: Array<string>;
                        src_table_path?: string;
                        client_token: string;
                    };
                    path: { app_token: string };
                },
                ...
                return this.httpInstance
                    ...
                    >({
                        url: fillApiPath(
                            `${this.domain}/open-apis/bitable/v1/apps/:app_token/connectors`,
                            path
                        ),
                        method: "POST",
                        data,
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=bitable&resource=app.connector&apiName=list&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=list&project=bitable&resource=app.connector&version=v1 document }
             *
             * 列出连接器
             *
             * 分页列举单个多维表格下的连接器。
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=bitable&resource=app.connector&apiName=delete&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=delete&project=bitable&resource=app.connector&version=v1 document }
             *
             * 删除连接器
             *
             * 删除同一个多维表格下的多个连接器。
                ...
                return this.httpInstance
                    .request<
                        any,
                        {
                            ...
                            data?: {
                                success_num?: number;
                                fail_table_ids?: Array<string>;
                                invalid_table_ids?: Array<string>;
                            };
                        }
                    >({
                        url: fillApiPath(
