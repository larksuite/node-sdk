...
export default abstract class Client {
    ...
    acs = {
        ...
        accessRecord: {
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=acs&resource=access_record&apiName=create&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=create&project=acs&resource=access_record&version=v1 document }
             *
             * 上传门禁访问记录
             *
             * 上传门禁访问记录
        ...
        device: {
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=acs&resource=device&apiName=delete&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=delete&project=acs&resource=device&version=v1 document }
             *
             * 解绑门禁机
             *
             * 解绑门禁机
            ...
            delete: async (
                ...
                return this.httpInstance
                    .request<any, { code?: number; msg?: string; data?: {} }>({
                        url: fillApiPath(
                            `${this.domain}/open-apis/acs/v1/devices/:device_id`,
                            path
                        ),
                        method: "DELETE",
                        data,
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=acs&resource=device&apiName=create&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=create&project=acs&resource=device&version=v1 document }
             *
             * 绑定门禁机
             *
             * 绑定门禁机
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=acs&resource=device&apiName=users_bind&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=users_bind&project=acs&resource=device&version=v1 document }
             *
             * 门禁设备与用户绑定、解绑
             *
             * 门禁设备与用户绑定、解绑
            ...
            usersBind: async (
                ...
                return this.httpInstance
                    .request<any, { code?: number; msg?: string; data?: {} }>({
                        url: fillApiPath(
                            `${this.domain}/open-apis/acs/v1/devices/:device_id/users_bind`,
                            path
                        ),
                        method: "POST",
                        data,
        ...
        userFace: {
            ...
            /**
             * {@link https://open.feishu.cn/api-explorer?project=acs&resource=user.face&apiName=remind&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=remind&project=acs&resource=user.face&version=v1 document }
             *
             * 人脸录入通知
             *
             * 人脸录入通知
            ...
            remind: async (
                ...
                return this.httpInstance
                    .request<any, { code?: number; msg?: string; data?: {} }>({
                        url: fillApiPath(
                            `${this.domain}/open-apis/acs/v1/users/:user_id/face/remind`,
                            path
                        ),
                        method: "POST",
                        data,
        ...
        deviceProperty: {
            /**
             * {@link https://open.feishu.cn/api-explorer?project=acs&resource=device.property&apiName=update&version=v1 click to debug }
             *
             * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=update&project=acs&resource=device.property&version=v1 document }
             *
             * 更新设备属性信息
             *
             * 更新设备属性信息
            ...
            update: async (
                ...
                return this.httpInstance
                    .request<any, { code?: number; msg?: string; data?: {} }>({
                        url: fillApiPath(
                            `${this.domain}/open-apis/acs/v1/devices/:device_id/property`,
                            path
                        ),
                        method: "PUT",
                        data,
