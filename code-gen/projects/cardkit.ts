    ...
    cardkit = {
        v1: {
            ...
            cardTemplate: {
                listWithIterator: async (
                    ...
                    const sendRequest = async (innerPayload: {
                        ...
                        const res = await this.httpInstance
                            .request<any, any>({
                                url: fillApiPath(
                                    `${this.domain}/open-apis/cardkit/v1/card_templates`,
                                    path
                                ),
                                method: "GET",
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=card_template&apiName=list&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=list&project=cardkit&resource=card_template&version=v1 document }
                 *
                 * 获取卡片模板列表
                 *
                 * 获取卡片模板列表
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=card_template&apiName=get&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=get&project=cardkit&resource=card_template&version=v1 document }
                 *
                 * 获取卡片模板详情
                 *
                 * 获取卡片模板详情
                ...
                get: async (
                    payload?: {
                        params?: { template_version_name?: string };
                        path: { card_template_id: string };
                    },
                    options?: IRequestOptions
                ) => {
                    const { headers, params, data, path } =
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/cardkit/v1/card_templates/:card_template_id`,
                                path
                            ),
                            method: "GET",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=card_template&apiName=meta&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=meta&project=cardkit&resource=card_template&version=v1 document }
                 *
                 * 获取卡片模板元信息
                 *
                 * 获取卡片模板元信息
                ...
                meta: async (
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/cardkit/v1/card_templates/:card_template_id/meta`,
                                path
                            ),
                            method: "GET",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=card_template&apiName=version&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=version&project=cardkit&resource=card_template&version=v1 document }
                 *
                 * 获取卡片模板已发布版本
                 *
                 * 获取卡片模板已发布版本
                    ...
                    return this.httpInstance
                        .request<
                            any,
                            {
                                code?: number;
                                msg?: string;
                                data?: { template_versions?: Array<string> };
                            }
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/cardkit/v1/card_templates/:card_template_id/version`,
                                path
                            ),
                            method: "GET",
                            data,
            ...
            kaCardTemplate: {
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=ka_card_template&apiName=get&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=get&project=cardkit&resource=ka_card_template&version=v1 document }
                 */
                get: async (
                    payload?: {
                        params?: { template_version_name?: string };
                        path: { ka_card_template_id: string };
                    },
                    options?: IRequestOptions
                ) => {
                    const { headers, params, data, path } =
                        ...
                        .request<
                            any,
                            {
                                ...
                                data?: {
                                    ...
                                    user_dsl?: string;
                                    variables?: string;
                                    variable_constraint?: string;
                                    images?: Array<string>;
                                };
                            }
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/cardkit/v1/ka_card_templates/:ka_card_template_id`,
                                path
                            ),
                            method: "GET",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=ka_card_template&apiName=create&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=create&project=cardkit&resource=ka_card_template&version=v1 document }
                 */
                create: async (
                    payload?: {
                        data?: {
                            ka_card_template?: {
                                ...
                                update_time?: string;
                                host_config?: string;
                                template_versions?: Array<string>;
                                bind_apps?: Array<string>;
                            };
                            user_dsl?: string;
                            variables?: string;
                            variable_constraint?: string;
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/cardkit/v1/ka_card_templates`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=ka_card_template&apiName=list&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=list&project=cardkit&resource=ka_card_template&version=v1 document }
                 */
                list: async (
                    payload?: {
                        params?: {
            ...
            /**
             * ka_card_template_old
             */
            kaCardTemplateOld: {
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=ka_card_template_old&apiName=create&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=create&project=cardkit&resource=ka_card_template_old&version=v1 document }
                 */
                create: async (
                    payload?: {
                        data?: {
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/cardkit/v1/ka_card_template_olds`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=cardkit&resource=ka_card_template_old&apiName=list&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=list&project=cardkit&resource=ka_card_template_old&version=v1 document }
                 */
                list: async (
                    payload?: {
                        params?: {
