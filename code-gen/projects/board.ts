    ...
    board = {
        v1: {
            ...
            whiteboardNode: {
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard.node&apiName=batch_query&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=batch_query&project=board&resource=whiteboard.node&version=v1 document }
                 *
                 * 按条件查询节点数据
                 */
                batchQuery: async (
                    payload?: {
                        data?: { ids?: Array<string>; with_children?: boolean };
                        params?: {
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/nodes/batch_query`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard.node&apiName=batch_update&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=batch_update&project=board&resource=whiteboard.node&version=v1 document }
                 *
                 * 批量更新画板节点信息
                 */
                batchUpdate: async (
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/nodes/batch_update`,
                                path
                            ),
                            method: "PUT",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard.node&apiName=update&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=update&project=board&resource=whiteboard.node&version=v1 document }
                 *
                 * 更新节点信息
                 */
                update: async (
                    payload?: {
                        ...
                        path: { whiteboard_id: string; node_id: string };
                    },
                    options?: IRequestOptions
                ) => {
                    const { headers, params, data, path } =
                    ...
                    return this.httpInstance
                        .request<
                            any,
                            {
                                code?: number;
                                msg?: string;
                                data?: { previous_revision?: string };
                            }
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/nodes/:node_id`,
                                path
                            ),
                            method: "PUT",
                            data,
            ...
            whiteboard: {
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard&apiName=unsubscribe&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=unsubscribe&project=board&resource=whiteboard&version=v1 document }
                 *
                 * 取消订阅画板编辑事件
                 */
                unsubscribe: async (
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/unsubscribe`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard&apiName=export&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=export&project=board&resource=whiteboard&version=v1 document }
                 *
                 * 导出画板为指定格式
                 */
                export: async (
                    payload?: {
                        data: { export_type: "svg" };
                        path: { whiteboard_id: string };
                    },
                    options?: IRequestOptions
                ) => {
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/export`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard&apiName=subscribe&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=subscribe&project=board&resource=whiteboard&version=v1 document }
                 *
                 * 订阅画板事件
                 *
                 * 订阅画板的各类通知事件。调用该接口并在开发者后台添加事件后，当画板发生指定事件时，系统会向配置的地址发送事件。
                 */
                subscribe: async (
                    payload?: {
                        data: { event_type: string };
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/subscribe`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard&apiName=parse_syntax&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=parse_syntax&project=board&resource=whiteboard&version=v1 document }
                 */
                parseSyntax: async (
                    payload?: {
                        data: {
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/parse_syntax`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard&apiName=title&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=title&project=board&resource=whiteboard&version=v1 document }
                 *
                 * 获取画板标题
                 */
                title: async (
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/title`,
                                path
                            ),
                            method: "GET",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard&apiName=update_title&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=update_title&project=board&resource=whiteboard&version=v1 document }
                 *
                 * 更新画板标题
                 */
                updateTitle: async (
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/update_title`,
                                path
                            ),
                            method: "POST",
                            data,
                ...
                /**
                 * {@link https://open.feishu.cn/api-explorer?project=board&resource=whiteboard&apiName=reset_version&version=v1 click to debug }
                 *
                 * {@link https://open.feishu.cn/api-explorer?from=op_doc_tab&apiName=reset_version&project=board&resource=whiteboard&version=v1 document }
                 *
                 * 将画板回退到指定历史版本
                 */
                resetVersion: async (
                    payload?: {
                        data: { target_revision: string };
                        path: { whiteboard_id: string };
                    },
                    options?: IRequestOptions
                ) => {
                    ...
                    return this.httpInstance
                        ...
                        >({
                            url: fillApiPath(
                                `${this.domain}/open-apis/board/v1/whiteboards/:whiteboard_id/reset_version`,
                                path
                            ),
                            method: "POST",
                            data,
